...
const EN: I18nStrings = {
    ...
    q3BrdText: 'Do you have a written product spec (BRD — Business Requirements Document)?',
    q3BrdLocked: 'Yes, I have a finalized product spec',
    q3BrdDraft: 'I have a draft but it\'s not final yet',
    q3BrdNone: 'No — I need help defining the product scope',
...
const VI: I18nStrings = {
    ...
    q3BrdText: 'Ban da co tai lieu mo ta san pham (BRD — Business Requirements Document) chua?',
    q3BrdLocked: 'Co roi, da chot xong',
    q3BrdDraft: 'Co nhung van la ban nhap, chua chot',
    q3BrdNone: 'Chua co — can giup dinh hinh san pham',
